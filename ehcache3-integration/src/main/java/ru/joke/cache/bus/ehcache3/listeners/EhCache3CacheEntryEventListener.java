...
@ThreadSafe
@Immutable
final class EhCache3CacheEntryEventListener<K extends Serializable, V extends Serializable> implements CacheEventListener<K, V>, ru.joke.cache.bus.core.CacheEventListener<K, V> {
