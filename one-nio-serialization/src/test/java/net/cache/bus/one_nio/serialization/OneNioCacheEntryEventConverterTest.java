...
public class OneNioCacheEntryEventConverterTest {

    private static CacheEntryEventConverter converter;

    @BeforeAll
    public static void init() {
        converter = new OneNioCacheEntryEventConverter();
    }
    ...
    private record Key(
            String keyStr,
            long keyLong,
            OneNioCacheEntryEventConverterTest.Key keyComplex) implements Serializable {
    ...
    private record Value(
            ...
            boolean fieldBool,
            OneNioCacheEntryEventConverterTest.Value fieldValue) implements Serializable {
