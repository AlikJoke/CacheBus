package ru.joke.cache.bus.kafka.configuration;
...
import ru.joke.cache.bus.kafka.channel.KafkaCacheBusMessageChannel;
 ...
 * @author Alik
 * @see KafkaCacheBusMessageChannel
 * @see Builder
 */
public record KafkaCacheBusMessageChannelConfiguration(
    ...
    public static class Builder {
        ...
        /**
         * Constructs a {@link KafkaCacheBusMessageChannel} object based on the data provided during the object's construction.
         *
         * @return cannot be {@code null}.
